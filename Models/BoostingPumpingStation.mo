model BoostingPumpingStation "Model of a pumping system for drinking water"
  ...
  Modelica.Blocks.Sources.Step valveOpening(startTime = 200, offset = 1e-6) annotation(
  ...
  Modelica.Blocks.Logical.TriggeredTrapezoid PumpRPMGenerator(rising = 3, falling = 3, amplitude = 1200, offset = 0.001) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput reservoirLevel annotation(
    Placement(visible = true, transformation(origin = {102, -62}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {96, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput pumpRotationalSpeed annotation(
    Placement(visible = true, transformation(origin = {102, -84}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {96, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
...
Simulate for 2000 s. When the valve is opened at time t=200, the pump starts turning on and off to keep the reservoir level around 2 meters, which roughly corresponds to a gauge pressure of 200 mbar.
  ...
  Icon(graphics = {Polygon(lineColor = {0, 0, 255}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, points = {{-48, -60}, {-72, -100}, {72, -100}, {48, -60}, {-48, -60}}), Polygon(fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.HorizontalCylinder, points = {{-28, 30}, {-28, -30}, {50, -2}, {-28, 30}}), Rectangle(fillColor = {0, 127, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, 46}, {100, -46}}), Ellipse(fillColor = {0, 100, 199}, fillPattern = FillPattern.Sphere, extent = {{-80, 80}, {80, -80}}), Polygon(fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.HorizontalCylinder, points = {{-28, 30}, {-28, -30}, {50, -2}, {-28, 30}})}));
end BoostingPumpingStation;
